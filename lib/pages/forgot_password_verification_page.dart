                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10,),
                            Text(
                              'Masukkan kode verifikasi yang anda terima pada E-mail.',
                              style: TextStyle(
                                // fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black54
                          ...
                          children: <Widget>[
                            ...
                            Text.rich(
                              TextSpan(
                                children: [
                                  TextSpan(
                                    text: "kamu tidak menerima kode verifikasi! ",
                                    style: TextStyle(
                                      ...
                                      ..onTap = () {
                                        showDialog(
                                          ...
                                          builder: (BuildContext context) {
                                            return ThemeHelper().alartDialog("Sukses",
                                                "Kode verifikasi sukses terkirim.",
                                                context);
                                          },
                                        );
                                      },
