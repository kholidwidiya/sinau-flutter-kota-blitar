...
import 'package:sinau_flutter/pages/login_page.dart';
import 'package:sinau_flutter/pages/splash_screen.dart';
        ...
        child: Container(
          ...
          child: ListView(
            children: [
              ...
              Divider(color: Theme.of(context).primaryColor, height: 1,),
              ListTile(
                leading: Icon(Icons.book_sharp, size: _drawerIconSize,color: Theme.of(context).accentColor,),
                title: Text('Sinau Flutter',style: TextStyle(fontSize: _drawerFontSize,color: Theme.of(context).accentColor),),
                onTap: () {
                  Navigator.push( context, MaterialPageRoute(builder: (context) => sinauflutter()), );
                },
              ),
              Divider(color: Theme.of(context).primaryColor, height: 1,),
              ListTile(
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text('MOH KHOLID W', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
                  SizedBox(height: 20,),
                  Text('sinau flutter', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                  SizedBox(height: 10,),
                  Container(
                    padding: EdgeInsets.all(10),
                    child: Column(
                                    ...
                                    ...ListTile.divideTiles(
                                      ...
                                      tiles: [
                                        ...
                                        ListTile(
                                          ...
                                          title: Text("Email"),
                                          subtitle: Text("kholidwidiya@gmail.com"),
                                        ),
                                        ListTile(
